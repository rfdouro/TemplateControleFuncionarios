...
<%@taglib uri="/WEB-INF/tlds/RFDOURO.tld" prefix="rfd" %>
...
<html>
 <head>
  ...
  <script src="${cp}/resources/vendor/moment.js/locale/pt-br.js" type="text/javascript"></script>
  <script src="${cp}/resources/vendor/moment.js/moment-with-locales.min.js" type="text/javascript"></script>
  <script src="${cp}/resources/vendor/moment.js/moment.min.js" type="text/javascript"></script>
  <!--script src="${cp}/resources/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script-->


  <link href="${cp}/resources/vendor/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css"/>
  <script src="${cp}/resources/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
  <script src="${cp}/resources/vendor/bootstrap-datepicker/locales/bootstrap-datepicker.pt-BR.min.js" type="text/javascript"></script>
  ...
  <script src="${cp}/resources/js/vue/VueComponentes.js" type="text/javascript"></script>
  <script src="${cp}/resources/js/vue/VueDiretivas.js" type="text/javascript"></script>
  <script src="${cp}/resources/js/vue/VueFiltros.js" type="text/javascript"></script>
 </head>
